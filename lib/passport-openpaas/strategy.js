...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'http://openpaas.io/login/oauth/authorize';
  options.tokenURL = options.tokenURL || 'http://openpaas.io/login/oauth/access_token';
  options.profileURL = options.profileURL || 'http://openpaas.io/user';
